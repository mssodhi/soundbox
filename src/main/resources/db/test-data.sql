...
INSERT INTO soundbox.song (`id`, `title`, `duration`, `plays`, `likes`, `comments_length`, `user_id`, `identifier`, `created_date`, `last_modified_date`, `song_url`, `release_date`) VALUES (1, 'First', 1200, 0, 0, 0, 1, 'testsong', '2016-06-05 12:47:00', '2016-06-05 12:47:00', 'https://s3-us-west-1.amazonaws.com/soundbox-prod/local/songs/testsong', '2016-08-14 00:00:00')
